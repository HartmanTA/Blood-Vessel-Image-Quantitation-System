...
class lungVesselSegWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self) -> None:
        ...
        #self.ui.batchProcessPushButton TODO batch processing
...
class lungVesselSegLogic(ScriptedLoadableModuleLogic):
    ...
    def vesselFinder(self, volumeNode):
    ...
    def process(self,
        ...
        self.findAllCenterlines(self.vesselFinder(inputVolume), subdivideInputSurface, self.centroidFinder(inputVolumeAsArray), decimationAggressiveness, targetNumberOfPoints)
